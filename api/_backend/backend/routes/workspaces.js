...
router.post('/', optionalAuth, requireAuth, async (req, res) => {
    ...
    const cloneFromWorkspaceId = typeof body.cloneFromWorkspaceId === 'string' && body.cloneFromWorkspaceId.trim()
...
router.post('/:id/members', requireAuth, async (req, res) => {
    ...
    const role = (['admin', 'member', 'viewer'].includes(String(body.role)) ? body.role : 'member');
    try {
